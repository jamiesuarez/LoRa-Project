...
void loop() {
 ...
 // getMode();
     ...
     Serial.print("Waiting for rxDone IRQ... ");
...
//    variableHex("REG_FIFO_RX_CURRENT_ADDR = 0x", readRegister(REG_FIFO_RX_CURRENT_ADDR));
    variableDec("REG_RX_NB_BYTES = ", readRegister(REG_RX_NB_BYTES));




    // step 6: récup data (recycling)
